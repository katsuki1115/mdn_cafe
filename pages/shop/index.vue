		...
		<div class="w-full md:max-w-3xl mx-auto pt-20 px-6 md:px-0">
			...
			<div class="mb-10">
				<iframe
					...
					frameborder="0" class="w-full h-64" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
			</div>
			<div class="mx-auto mb-10 text-center">
				<nuxt-link to="/"
					class="rounded-lg px-4 md:px-5 xl:px-4 py-3 md:py-4 xl:py-3 bg-white hover:bg-gray-200 md:text-lg xl:text-base text-gray-800 font-semibold leading-tight shadow-md">トップへ戻る</nuxt-link>
			</div>
		</div>
	</div>
</template>
